            ...
            <div class="row">
				<div class="col-md-12">
					<?php 
						...
						$det = mysql_query("SELECT tb_pengembalian.id_pengembalian, tb_transaksi.id_transaksi, tb_transaksi.harga, tb_pengembalian.terlambat from mobilrental.tb_transaksi inner join mobilrental.tb_pengembalian on (tb_transaksi.id_transaksi = tb_pengembalian.id_transaksi) where id_pengembalian='$id_pengembalian'")or die(mysql_error());
