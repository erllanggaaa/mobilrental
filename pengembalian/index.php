...
$sql 		= "SELECT tb_pengembalian.id_pengembalian, tb_transaksi.id_transaksi, tb_transaksi.nama_lengkap, tb_pengembalian.terlambat from mobilrental.tb_transaksi inner join mobilrental.tb_pengembalian on (tb_transaksi.id_transaksi = tb_pengembalian.id_transaksi) WHERE nama_lengkap LIKE '%$keyword%' ORDER BY id_pengembalian";
			
$result = mysql_query($sql);
}else{
	//  jika tidak ada pencarian pakai ini
$reload = "index.php?pagination=true";
$sql    = "SELECT tb_pengembalian.id_pengembalian, tb_transaksi.id_transaksi, tb_transaksi.nama_lengkap, tb_pengembalian.terlambat from mobilrental.tb_transaksi inner join mobilrental.tb_pengembalian on (tb_transaksi.id_transaksi = tb_pengembalian.id_transaksi) ORDER BY id_pengembalian"; 
$result = mysql_query($sql);
}
//pagination
...
<head>
    <title>RENTAL MOBIL SIJONES - Data Pengembalian</title>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
					...
					<ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-arrow-circle-o-right"></i> Pengembalian
                            </li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<button data-toggle="modal" data-target="#myModal" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> Tambah Data Pengembalian</button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
										<tr>
											...
											<td>
												<center>
												<a class="btn btn-sm btn-info" href="edit.php?id_pengembalian=<?php echo $data['id_pengembalian'] ?>" title="Edit Data" ><span class="fa fa-edit"></span></a>
