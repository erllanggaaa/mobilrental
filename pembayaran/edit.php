            ...
            <div class="row">
				<div class="col-md-12">
					<?php 
						...
						$det = mysql_query("SELECT tb_pembayaran.id_bayar, tb_pembayaran.tgl_bayar, tb_transaksi.id_transaksi, tb_pembayaran.pembayaran, tb_pembayaran.no_rek, tb_pembayaran.nama_bank, tb_pembayaran.atas_nama from mobilrental.tb_transaksi inner join mobilrental.tb_pembayaran on (tb_transaksi.id_transaksi = tb_pembayaran.id_transaksi) where id_bayar='$id_bayar'")or die(mysql_error());
