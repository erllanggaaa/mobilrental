...
$sql 		= "SELECT tb_pembayaran.id_bayar, tb_pembayaran.tgl_bayar, tb_transaksi.id_transaksi, tb_transaksi.nama_lengkap, tb_pembayaran.pembayaran, tb_pembayaran.no_rek, tb_pembayaran.nama_bank, tb_pembayaran.atas_nama from mobilrental.tb_transaksi inner join mobilrental.tb_pembayaran on (tb_transaksi.id_transaksi = tb_pembayaran.id_transaksi) WHERE nama_lengkap LIKE '%$keyword%' ORDER BY id_bayar";
			
$result = mysql_query($sql);
}else{
	//  jika tidak ada pencarian pakai ini
$reload = "index.php?pagination=true";
$sql    = "SELECT tb_pembayaran.id_bayar, tb_pembayaran.tgl_bayar, tb_transaksi.id_transaksi, tb_transaksi.nama_lengkap, tb_pembayaran.pembayaran, tb_pembayaran.no_rek, tb_pembayaran.nama_bank, tb_pembayaran.atas_nama from mobilrental.tb_transaksi inner join mobilrental.tb_pembayaran on (tb_transaksi.id_transaksi = tb_pembayaran.id_transaksi) ORDER BY id_bayar"; 
$result = mysql_query($sql);
}
//pagination
...
<head>
    <title>RENTAL MOBIL SIJONES - Data Pembayaran</title>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
					...
					<ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-arrow-circle-o-right"></i> Pembayaran
                            </li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<button data-toggle="modal" data-target="#myModal" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> Tambah Data Pembayaran</button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
										<tr>
											...
											<td>
												<center>
												<a class="btn btn-sm btn-info" href="edit.php?id_bayar=<?php echo $data['id_bayar'] ?>" title="Edit Data" ><span class="fa fa-edit"></span></a>
