...
<head>
    <title>RENTAL MOBIL SIJONES - Data Pelanggan</title>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
					...
					<ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-arrow-circle-o-right"></i> Pelanggan
                            </li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<button data-toggle="modal" data-target="#myModal" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> Tambah Data Pelanggan</button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
										<tr>
											...
											<td><?php if ($data['status_peminjaman'] == 1){ echo 'Approve'; } else { echo 'Pending' ;} ?></td>
											<td>
												<center>
												<a class="btn btn-sm btn-warning" href="laporan.php?id_pelanggan=<?php echo $data['id_pelanggan'] ?>" target="_blank" title="Print Data" ><span class="fa fa-print"></span></a>
												<a class="btn btn-sm btn-info" href="edit.php?id_pelanggan=<?php echo $data['id_pelanggan'] ?>" title="Edit Data" ><span class="fa fa-edit"></span></a>
