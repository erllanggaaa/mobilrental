...
$sql 		= "SELECT tb_mobil.id_mobil, tb_mobil.foto_mobil, tb_jenis.nama_jenis, tb_mobil.type_mobil, tb_mobil.merk, tb_mobil.no_polisi, tb_mobil.warna, tb_mobil.harga, tb_mobil.status from mobilrental.tb_jenis inner join mobilrental.tb_mobil on (tb_jenis.id_jenis = tb_mobil.id_jenis) WHERE type_mobil LIKE '%$keyword%' ORDER BY id_mobil asc";
			
$result = mysql_query($sql);
}else{
	//  jika tidak ada pencarian pakai ini
$reload = "index.php?pagination=true";
$sql    = "SELECT tb_mobil.id_mobil, tb_mobil.foto_mobil, tb_jenis.nama_jenis, tb_mobil.type_mobil, tb_mobil.merk, tb_mobil.no_polisi, tb_mobil.warna, tb_mobil.harga, tb_mobil.status from mobilrental.tb_jenis inner join mobilrental.tb_mobil on (tb_jenis.id_jenis = tb_mobil.id_jenis) ORDER BY id_mobil asc"; 
$result = mysql_query($sql);
}
//pagination
...
<head>
    <title>RENTAL MOBIL SIJONES - Data Mobil</title>
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<button data-toggle="modal" data-target="#myModal" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> Tambah Data Mobil</button></div>
                        <div class="panel-body">
							...
							<a href="laporan.php" target="_blank" class="btn btn-warning pull-left"><i class="fa fa-print"></i> Cetak</a></br></br>
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
										<tr>
											...
											<td align="center"><img src="gambar/<?php echo $data['foto_mobil'] ?>" width="200px" height="150px"/></td>
											...
											<td>
												<center>
												<a class="btn btn-sm btn-info" href="edit.php?id_mobil=<?php echo $data['id_mobil'] ?>" title="Edit Data" ><span class="fa fa-edit"></span></a>
