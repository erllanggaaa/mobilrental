            ...
            <div class="row">
				<div class="col-md-12">
					<?php 
						...
						$det = mysql_query("SELECT tb_mobil.id_mobil, tb_mobil.foto_mobil, tb_jenis.nama_jenis, tb_mobil.type_mobil, tb_mobil.merk, tb_mobil.no_polisi, tb_mobil.warna, tb_mobil.harga, tb_mobil.status from mobilrental.tb_jenis inner join mobilrental.tb_mobil on (tb_jenis.id_jenis = tb_mobil.id_jenis) where id_mobil='$id_mobil'")or die(mysql_error());
							...
							<form action="update.php" method="post" enctype="multipart/form-data">
								<table class="table">
									...
									<tr>
										<td>Foto</td>
										<td>
											<img src="gambar/<?php echo $d['foto_mobil'] ?>" width="250px" height="120px" /></br>
