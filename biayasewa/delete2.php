...
$data1 = "SELECT id_mobil from tb_transaksi where id_transaksi='$id_transaksi'"
	...
	if($hasil){
		$dt=mysql_query("SELECT tb_mobil.id_mobil as id_mobil, tb_mobil.foto_mobil, tb_jenis.nama_jenis, tb_mobil.type_mobil, tb_mobil.merk, tb_mobil.no_polisi, tb_mobil.warna, tb_mobil.harga, tb_mobil.status from mobilrental.tb_jenis inner join mobilrental.tb_mobil on (tb_jenis.id_jenis = tb_mobil.id_jenis) where id_mobil='$data1'");
