...
$sql 		= "SELECT tb_transaksi.id_transaksi, tb_mobil.id_mobil, tb_mobil.type_mobil, tb_mobil.harga, tb_pelanggan.no_ktp as id_pelanggan, tb_pelanggan.nama_lengkap, tb_transaksi.tgl_sewa, tb_transaksi.tgl_selesaisewa, tb_transaksi.jumlah_harga, tb_transaksi.denda, tb_transaksi.status_pembayaran, tb_transaksi.status_pengembalian 
				...
				INNER JOIN mobilrental.tb_pelanggan on (tb_pelanggan.id_pelanggan=tb_transaksi.id_pelanggan) WHERE type_mobil LIKE '%$keyword%' or tgl_sewa LIKE '%$keyword%' ORDER BY id_transaksi";
...
$sql    = "SELECT tb_transaksi.id_transaksi, tb_mobil.id_mobil, tb_mobil.type_mobil, tb_mobil.harga, tb_pelanggan.no_ktp, tb_pelanggan.nama_lengkap, tb_transaksi.tgl_sewa, tb_transaksi.tgl_selesaisewa, tb_transaksi.jumlah_harga, tb_transaksi.denda, tb_transaksi.status_pembayaran, tb_transaksi.status_pengembalian 
				FROM mobilrental.tb_transaksi 
				INNER JOIN mobilrental.tb_mobil on (tb_mobil.id_mobil=tb_transaksi.id_mobil)
				INNER JOIN mobilrental.tb_pelanggan on (tb_pelanggan.id_pelanggan=tb_transaksi.id_pelanggan) ORDER BY id_transaksi"; 
$result = mysql_query($sql);
}
//pagination
...
<head>
    <title>RENTAL MOBIL SIJONES - Transaksi Sewa</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Transaksi Sewa</h1>
					<ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-arrow-circle-o-right"></i> Transaksi Sewa
                            </li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <div class="row">
				<div class="col-md-12">
					<div class="alert alert-info alert-dismissable">
                        ...
                        1. Icon <i class="fa fa-plus-circle"></i> berfunsi sebagai menambah data Mobil <br>
						2. Icon <i class="fa fa-edit"></i> berfunsi untuk mengedit data Mobil yang dipilih <br>
						2. Icon <i class="fa fa-trash"></i> berfunsi untuk menghapus data Mobil yang dipilih
					</div>
					
					<div class="panel panel-primary">
                        <div class="panel-heading">
						<button data-toggle="modal" data-target="#myModal" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> Tambah Data Transaksi Sewa</button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
										<tr>
											...
											<td>
												<center>
												<a class="btn btn-sm btn-warning" href="laporan.php?id_transaksi=<?php echo $data['id_transaksi'] ?>" target="_blank" title="Print Data" ><span class="fa fa-print"></span></a>
												<a class="btn btn-sm btn-info" href="edit.php?id_transaksi=<?php echo $data['id_transaksi'] ?>" title="Edit Data" ><span class="fa fa-edit"></span></a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Tambah Transaksi Sewa Baru</h4>
				</div>
					...
					<form action="tambah.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<select class="form-control" name="id_mobil" required="required" id="id_mobil">
								...
								<?php 
								$mbl=mysql_query("select tb_mobil.id_mobil, tb_mobil.foto_mobil, tb_jenis.nama_jenis, tb_mobil.type_mobil, tb_mobil.merk, tb_mobil.no_polisi, tb_mobil.warna, tb_mobil.harga, tb_mobil.status from mobilrental.tb_jenis inner join mobilrental.tb_mobil on (tb_jenis.id_jenis = tb_mobil.id_jenis)");
						...
						<div class="form-group">
							...
							<div class='input-group date' id='datetimepicker'>
								<input name="tanggal_sewa" type="text" class="form-control" placeholder="Tanggal Sewa .." required/><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
							</div>
						</div>
						<div class="form-group">
							<label>Tanggal Selesai Sewa</label>
							<div class='input-group date' id='datetimepicker1'>
								<input name="tanggal_selesai_sewa" type="text" class="form-control" placeholder="Tanggal Selesai Sewa .." required/><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
							</div>
						</div>
